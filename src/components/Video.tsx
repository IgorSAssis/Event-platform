...
export function Video({ lessonSlug }: VideoProps) {
  ...
  const { videoId, description, title, teacher } = data.lesson;

  return (
    <div className="flex-1">
      <div className="bg-black flex justify-center">
        <div className="h-full w-full max-w-[1100px] pax-h-[64vh] aspect-video">
          <Player>
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4 mt-6">
                <img
                  ...
                  alt="avatar"
                  className="h-16 w-16 rounded border-2 border-blue-500"
                />
